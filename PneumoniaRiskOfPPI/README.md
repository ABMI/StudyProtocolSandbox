...
2. In 'R', use the following code to install the PneumoniaRiskOfPPI package:
...
3. Once installed, you can execute the study by modifying and using the following code:
	...
	outputFolder <- "c:/PneumoniaRiskOfPPI"
...
License
=======
The PneumoniaRiskOfPPI package is licensed under Apache License 2.0


Development
===========
PneumoniaRiskOfPPI was developed in ATLAS and R Studio.
