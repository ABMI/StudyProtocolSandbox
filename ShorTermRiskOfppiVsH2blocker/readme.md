...
2. In 'R', use the following code to install the ShorTermRiskOfppiVsH2blocker package:
...
3. Once installed, you can execute the study by modifying and using the following code:
	...
	```r
	library(ShorTermRiskOfppiVsH2blocker)
	...
	outputFolder <- "c:/ShorTermRiskOfppiVsH2blocker"
...
License
=======
The ShorTermRiskOfppiVsH2blocker package is licensed under Apache License 2.0


Development
===========
ShorTermRiskOfppiVsH2blocker was developed in ATLAS and R Studio.
