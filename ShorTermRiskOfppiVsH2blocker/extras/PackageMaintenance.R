...
OhdsiRTools::checkUsagePackage("ShorTermRiskOfppiVsH2blocker")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ShorTermRiskOfppiVsH2blocker.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ShorTermRiskOfppiVsH2blocker.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "ShorTermRiskOfppiVsH2blocker")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ShorTermRiskOfppiVsH2blocker")
